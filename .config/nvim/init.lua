...
-- Save undo history
vim.o.undofile = true
vim.o.undodir = "/Users/andreangeluci/.nvim/undodir"
...
vim.keymap.set('n', '<leader><space>', ':Neotree source=buffers position=float reveal<cr>', { desc = 'Neotree Show Buffers' })
vim.keymap.set('n', '<f4>', ':Neotree reveal<cr>', { desc = 'Neotree' })
vim.keymap.set('n', '<f2>', ':Neotree source=git_status position=float<cr>', { desc = 'Neotree Show Buffers' })

vim.keymap.set('n', '\\', ':term <cr>', { desc = 'Terminal'})
